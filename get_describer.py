...
def printinteractions():
    ...
    for i in range(len(out_types)):
        ...
        if 25 in unique_elements:
            ...
            percentage = percentages[index]
            result = [x*percentage for x in element_properties['Mn']]
            change_types+=result
            label_types.append(percentage)
            j=j+1
        else:
        ...
        if 26 in unique_elements:
            ...
            percentage = percentages[index]
            result = [x*percentage for x in element_properties['Fe']]
            change_types+=result
            label_types.append(percentage)
            j=j+1
        else:
        ...
        if 27 in unique_elements:
            ...
            percentage = percentages[index]
            result = [x*percentage for x in element_properties['Co']]
            change_types+=result
            label_types.append(percentage)
            j=j+1
        else:
        ...
        if 28 in unique_elements:
            ...
            percentage = percentages[index]
            result = [x*percentage for x in element_properties['Ni']]
            change_types+=result
            label_types.append(percentage)
            j=j+1
        else:
        ...
        if 46 in unique_elements:
            ...
            percentage = percentages[index]
            result = [x*percentage for x in element_properties['Pd']]
            change_types+=result
            label_types.append(percentage)
            j=j+1
        else:
